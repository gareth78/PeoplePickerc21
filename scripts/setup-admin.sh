...
echo "📋 Next Steps:"
echo ""
echo "1. Add your first admin to the database:"
echo "   psql \$DATABASE_URL -c \"INSERT INTO admins (id, email, created_by) VALUES (gen_random_uuid(), 'your-email@domain.com', 'system');\""
echo ""
